...
<div class="page-container row-fluid">
    <jsp:include page="../tool/sidebar.jsp">
        <jsp:param name="class" value="control-log"></jsp:param>
    </jsp:include>
                            ...
                            <table class="table table-striped table-bordered table-hover table-full-width"
                                ...
                                <c:forEach items="${records}" var="i">
                                    <tr>
                                        ...
                                        <td class="hidden-480">${i.operateFrom}</td>
                                        <td class="hidden-480">${i.operateTo}</td>
                                        <td class="hidden-480">
                                            <ex:date value="${i.operateTime}" pattern="yyyy-MM-dd HH:mm:ss"></ex:date>
                                        </td>
                                        <td class="hidden-480">${i.behavior}</td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                                <tfoot>
...
<script>
    function gotopage(page) {
        if (parseInt(page) <= 0 || parseInt(page) >=${maxpage+1})
            return;
        location.href = "/admin/log/list?operateFrom=${operateFrom}&operateTo=${operateTo}&starttime=${starttime}&endtime=${endtime}&page=" + page;
    }
</script>
