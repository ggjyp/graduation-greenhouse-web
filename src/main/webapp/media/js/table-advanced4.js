var TableAdvanced = function () {
    ...
    var initTable1 = function () {
        ...
        function fnFormatDetails(oTable, nTr) {
            ...
            var sOut = '<table>';
            sOut += '<tr><td style="white-space:nowrap;">反馈用户:</td><td>' + aData[1] + '</td></tr>';
            sOut += '<tr><td style="white-space:nowrap;">联系方式:</td><td>' + aData[2] + '</td></tr>';
            sOut += '<tr><td style="white-space:nowrap;">用户类型:</td><td>' + aData[3] + '</td></tr>';
            sOut += '<tr><td style="white-space:nowrap;">反馈时间:</td><td>' + aData[4] + '</td></tr>';
            sOut += '<tr><td style="white-space:nowrap;">反馈内容:</td><td>' + aData[5] + '</td></tr>';
            sOut += '</table>';
