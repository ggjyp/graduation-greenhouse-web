var TableAdvanced = function () {
    ...
    var initTable1 = function () {
        ...
        function fnFormatDetails(oTable, nTr) {
            ...
            var sOut = '<table>';
            sOut += '<tr><td style="white-space:nowrap;">版权资源图片:</td><td>' + aData[1] + '</td></tr>';
            sOut += '<tr><td style="white-space:nowrap;">标题:</td><td>' + aData[2] + '</td></tr>';
            sOut += '<tr><td style="white-space:nowrap;">简介:</td><td>' + aData[3] + '</td></tr>';
            sOut += '<tr><td style="white-space:nowrap;">发布时间:</td><td>' + aData[5] + '</td></tr>';
            sOut += '<tr><td style="white-space:nowrap;">详情:</td><td>' + aData[7]+'</td></tr>';
            sOut += '</table>';
