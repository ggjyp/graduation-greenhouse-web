...
/**
 * @fileoverview Media Technology front - Base class for media playback
...
/**
 * @fileoverview HTML5 Media front - Wrapper for HTML5 Media API
 */

/**
 * HTML5 Media front - Wrapper for HTML5 Media API
 * @param {vjs.Player|Object} player
 * @param {Object=} options
...
/**
 * Flash Media front - Wrapper for fallback SWF API
 *
